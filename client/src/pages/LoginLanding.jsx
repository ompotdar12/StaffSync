    ...
    <div className="min-h-screen flex flex-col md:flex-row">
        ...
        <div className="w-full max-w-md animate-fade-in relative z-10">
            ...
            <div className="mt-12 text-center md:text-left text-sm text-slate-400">
                <p>© {new Date().getFullYear()} Veeraj H. Bagmar. All rights reserved.</p>
            </div>
...
// key is for React's internal tracking. React uses the key to distinguish this element from the other elements generated by .map().You generally don't use key to control navigation.

// `to={portal.to}` tells the React Router `<Link>` where to navigate when the user clicks it. Here, `portal` represents the current element of the `portalOptions` array, and `.to` accesses its `to` property. For example, if `portal.to` is `"/login/admin"`, clicking the link navigates to `/login/admin`.
